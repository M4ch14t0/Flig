...
CREATE TABLE `estabelecimentos` (
  ...
  `descricao_empresa` text COLLATE utf8mb4_unicode_ci COMMENT 'Descrição da empresa',
  `imagem_empresa` longblob COMMENT 'Imagem da empresa em formato binário',
  `bairro_empresa` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Bairro da empresa',
  `cidade_empresa` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Cidade da empresa',
  `uf_empresa` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'UF da empresa',
  `numero_empresa` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Número do endereço da empresa',
  PRIMARY KEY (`id`),
  ...
  KEY `idx_estabelecimentos_descricao` (`descricao_empresa`(100)),
  KEY `idx_estabelecimentos_bairro` (`bairro_empresa`),
  KEY `idx_estabelecimentos_cidade` (`cidade_empresa`),
  KEY `idx_estabelecimentos_uf` (`uf_empresa`)
...
) ENGINE=InnoDB AUTO_INCREMENT=164 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Histórico de clientes que passaram pelas filas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Histórico de transações de pagamento para avanço de posições';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tabela de usuários (clientes) do sistema Flig';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-15 11:22:27
