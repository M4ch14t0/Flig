...
// Configuração da nova conexão Railway
const dbConfig = {
  host: 'switchyard.proxy.rlwy.net',
  port: 13625,
  user: 'root',
  password: 'jYFKnIHRXvurHgyuqVWYcTKevuUBqJom',
  database: 'railway',
  charset: 'utf8mb4',
  multipleStatements: true
};

async function importFligNewRailway() {
  let connection;
  
  try {
    console.log('🔧 Conectando ao novo Railway MySQL...');
    connection = await mysql.createConnection(dbConfig);
    console.log('✅ Conectado ao novo Railway MySQL!');
