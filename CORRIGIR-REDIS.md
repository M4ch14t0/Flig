# 🔴 Corrigir Problema do Redis - Railway
...
### Código
- [ ] **config/redis.js** usa `process.env.REDIS_URL`
...
### IPv6 Error
```bash
# Usar variáveis do Railway em vez de IPs fixos
# Verificar se REDISHOST está usando ${{RAILWAY_PRIVATE_DOMAIN}}
```
